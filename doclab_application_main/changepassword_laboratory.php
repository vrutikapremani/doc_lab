...
$select="select * from tbl_laboratory where lab_password='$_POST[txt_oldpassword]'";
$query=mysql_query($select);
$row=mysql_fetch_array($query);
if($row['lab_password']==$old)
{
$update="update tbl_laboratory set lab_password='$_POST[txt_newpassword]', lab_confirm_password='$_POST[txt_confirmnewpassword]' where lab_id='$_SESSION[lab_id]'";
