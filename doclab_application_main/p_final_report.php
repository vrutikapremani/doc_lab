...
<div class="container-padding">
  ...
  <div class="invoice row">
	...
	<div class="form-group has-success">
                  ...
                  <div class="col-sm-0">
                  <a href="p_print_prescription.php?appointment_id=<?php echo $row['appointment_id']; ?>"><button type="button" class="btn btn-primary"><i class="fa fa-print"></i>Print</button></a>
                  </div>
                </div>
				</table>
	</form>
