...
<?php
$noofrecords=10;
$select="elect * from  tbl_doctor_invoice c1 where c1.pat_id='$_SESSION[pat_id]' and c1.doc_id='$_GET[doc_id]' and c1.d_invoice_status=1 group by c1.unique_id";
...
<div class="panel panel-default">
        ...
        <ul class="panel-tools">
		 ...
		 <form  method="post" class="form-horizontal">
			  ...
			  {
				window.location.href="pd_paid_payment.php?doc_id="+d;
			  }
			  </script>
			 <div class="form-group has-success">
				  ...
				  <option>---------------Select Doctor Name---------------</option>
                    <?php
					$select="select * from tbl_doctor_invoice c1, tbl_doctor c2 where c1.pat_id='$_SESSION[pat_id]' and c1.d_invoice_status=1 and c1.doc_id=c2.doc_id group by c2.doc_id ";
					$query=mysql_query($select);
		 ...
		 <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
				...
				<!-- SELECT -->
				<?php
				$select="select * from  tbl_doctor_invoice c1 where c1.pat_id='$_SESSION[pat_id]' and c1.doc_id='$_GET[doc_id]' and c1.d_invoice_status=1 group by c1.unique_id".$limit;
				$query=mysql_query($select);
				while($row=mysql_fetch_array($query))
				{
				?>
				...
				?></td>
						...
						<td style="width:20px;"><a href="doctor_invoice1.php?unique_id=<?php echo $row['unique_id']; ?>"><img src="img/detail1.jpg"  align="middle"width="100px" height="30px" title="Details"/></a></td>
				</tr>
				<?php
				}
				?>
			...
			<table  align="center" style= "width:400px">
				<tr>
					<td><a href="pd_paid_payment.php?page=<?php echo $prepage; ?>" class="btn btn-rounded btn-default">Prepage</a></td>
					<td><a href="pd_paid_payment.php?page=<?php echo $nextpage; ?>" class="btn btn-rounded btn-default">Nextpage</a></td>
					<td><a href="pd_paid_payment.php?page=<?php echo $maxpage; ?>" class="btn btn-rounded btn-default">Maxpage</a></td>
				</tr>
			</table>
