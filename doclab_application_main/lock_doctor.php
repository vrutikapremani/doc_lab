...
$select="select * from tbl_doctor where doc_first_name='$username' and doc_password='$password'";
$query=mysql_query($select);
$row=mysql_fetch_array($query);
if($username==$row['doc_first_name'] && $password==$row['doc_password'])
{
...
?>
    ...
    <div class="login-form">
     ...
     <div class="col-xs-6"><a href="forgotpassword_d.php"><i class="fa fa-lock"></i>  Forgot Password</a></div>
      </div>
    </div>
