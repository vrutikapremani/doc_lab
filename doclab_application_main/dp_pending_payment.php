...
<?php
$noofrecords=10;
$select="select * from  tbl_doctor_invoice where doc_id='$_SESSION[doc_id]' and d_invoice_status=0 group by unique_id";
		...
		<br />
		 <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
				...
				$select_search="select * from tbl_doctor_invoice where doc_id='$_SESSION[doc_id]' and d_invoice_status=0 and unique_id like '%$search%' group by unique_id";
				$query=mysql_query($select_search);
				}
				else
				{
				$select="select * from  tbl_doctor_invoice where doc_id='$_SESSION[doc_id]' and d_invoice_status=0 group by unique_id".$limit;
				$query=mysql_query($select);
				}
				...
				?></td>
						...
						<td style="width:20px;"><a href="dp_invoice0.php?unique_id=<?php echo $row['unique_id']; ?>"><img src="img/detail1.jpg"  align="middle"width="100px" height="30px" title="View"/></a></td>
				</tr>
				<?php
				}
				?>
			...
			<table  align="center" style= "width:400px">
				<tr>
					<td><a href="dp_pending_payment.php?page=<?php echo $prepage; ?>" class="btn btn-rounded btn-default">Prepage</a></td>
					<td><a href="dp_pending_payment.php?page=<?php echo $nextpage; ?>" class="btn btn-rounded btn-default">Nextpage</a></td>
					<td><a href="dp_pending_payment.php?page=<?php echo $maxpage; ?>" class="btn btn-rounded btn-default">Maxpage</a></td>
				</tr>
			</table>
