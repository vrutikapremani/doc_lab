		...
		$s="select * from  tbl_doctor_invoice c1 , tbl_symptom c2 where c1.sym_id=c2.sym_id and c1.unique_id='$_GET[unique_id]' and d_invoice_status=1";
		 ...
		 <div class="panel-body table-responsive">
			...
			<table  align="center" style= "width:400px">
				<tr>
					<td><a href="dp_invoice1.php?page=<?php echo $prepage; ?>" class="btn btn-rounded btn-default">Prepage</a></td>
					<td><a href="dp_invoice1.php?page=<?php echo $nextpage; ?>" class="btn btn-rounded btn-default">Nextpage</a></td>
					<td><a href="dp_invoice1.php?page=<?php echo $maxpage; ?>" class="btn btn-rounded btn-default">Maxpage</a></td>
				</tr>
			</table>
