...
<?php
$noofrecords=10;
$select="select * from tbl_laboratory_invoice c1 , tbl_appointment c2 , tbl_symptom c3 where c1.appointment_id=c2.appointment_id and c2.appo_unique_id='$_GET[appo_unique_id]' and c2.sym_id=c3.sym_id and c1.l_invoice_status=0 group by c1.appointment_id";
...
<div class="panel panel-default">
		...
		<?php
		$s="select * from  tbl_laboratory_invoice c1 , tbl_appointment c2 where c1.appointment_id=c2.appointment_id and c2.appo_unique_id='$_GET[appo_unique_id]' and c1.l_invoice_status=0";
				$q=mysql_query($s);
		 ...
		 <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
				...
				$select_search="select * from tbl_laboratory_invoice c1 , tbl_appointment c2 , tbl_symptom c3 where c1.appointment_id=c2.appointment_id and c2.appo_unique_id='$_GET[appo_unique_id]' and c2.sym_id=c3.sym_id and c1.l_invoice_status=0 and c3.sym_name like '%$search%' group by c1.appointment_id";
				$query=mysql_query($select_search);
				}
				else
				{
				$select="select * from tbl_laboratory_invoice c1 , tbl_appointment c2 , tbl_symptom c3 where c1.appointment_id=c2.appointment_id and c2.appo_unique_id='$_GET[appo_unique_id]' and c2.sym_id=c3.sym_id and c1.l_invoice_status=0 group by c1.appointment_id".$limit;
				$query=mysql_query($select);
				}
			...
			<table  align="center" style= "width:400px">
				<tr>
					<td><a href="lp_invoice0.php?page=<?php echo $prepage; ?>" class="btn btn-rounded btn-default">Prepage</a></td>
					<td><a href="lp_invoice0.php?page=<?php echo $nextpage; ?>" class="btn btn-rounded btn-default">Nextpage</a></td>
					<td><a href="lp_invoice0.php?page=<?php echo $maxpage; ?>" class="btn btn-rounded btn-default">Maxpage</a></td>
				</tr>
			</table>
