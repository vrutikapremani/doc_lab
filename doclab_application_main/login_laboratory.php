...
{
$select="select * from tbl_laboratory where lab_email_id='$username' and lab_password='$password'";
$query=mysql_query($select);
$row=mysql_fetch_array($query);
if($username==$row['lab_email_id'] && $password==$row['lab_password'])
{
$_SESSION['firstname']=$row['lab_name'];
$_SESSION['password']=$row['lab_password'];
$_SESSION['lab_id']=$row['lab_id'];
$_SESSION['address']=$row['lab_address'];
$_SESSION['city']=$row['lab_city'];
$_SESSION['pincode']=$row['lab_pincode'];
?>
  ...
  <body>
    ...
    <div class="login-form">
      ...
      <div class="footer-links row">
        <div class="col-xs-6"><a href="add_laboratory.php"><i class="fa fa-external-link"></i> Register Now</a></div>
        <div class="col-xs-6 text-right"><a href="forgotpassword_l.php"><i class="fa fa-lock"></i> Forgot password</a></div>
      </div>
    </div>
