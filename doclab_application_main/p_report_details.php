...
<?php
$noofrecords=10;
$select="select * from  tbl_appointment c1 , tbl_symptom c2 where c1.sym_id=c2.sym_id and c1.appo_unique_id='$_GET[appo_unique_id]'";
...
<div class="panel panel-default">
		...
		<?php
		$s="select * from  tbl_appointment c1 , tbl_symptom c2 where c1.sym_id=c2.sym_id and c1.appo_unique_id='$_GET[appo_unique_id]'";
				$q=mysql_query($s);
		 ...
		 <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
			    ...
			    <tr>
						...
						<td style="width:20px;"><a href="p_final_report.php?appointment_id=<?php echo $row['appointment_id']; ?>"><img src="img/view.png"  align="middle"width="100px" height="30px" title="View"/></a></td>
				</tr>
				<?php
				}
				?>
			...
			<table  align="center" style= "width:400px">
				<tr>
					<td><a href="p_report_details.php?page=<?php echo $prepage; ?>" class="btn btn-rounded btn-default">Prepage</a></td>
					<td><a href="p_report_details.php?page=<?php echo $nextpage; ?>" class="btn btn-rounded btn-default">Nextpage</a></td>
					<td><a href="p_report_details.php?page=<?php echo $maxpage; ?>" class="btn btn-rounded btn-default">Maxpage</a></td>
				</tr>
			</table>
