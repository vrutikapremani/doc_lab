...
<?php
$noofrecords=10;
$select="select * from  tbl_appointment where pat_id='$_SESSION[pat_id]' group by appo_unique_id";
		...
		<input type="submit" name="btn_search" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" class="search_button" title="Search"/>
		 ...
		 <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
				...
				$select_search="select * from tbl_appointment where appo_unique_id like '%$search%' group by appo_unique_id";
				$query=mysql_query($select_search);
				}
				else
				{
				$select="select * from  tbl_appointment where pat_id='$_SESSION[pat_id]' group by appo_unique_id".$limit;
				$query=mysql_query($select);
				}
				...
				?></td>
						<td style="width:20px;"><a href="p_view_appointment.php?appo_unique_id=<?php echo $row['appo_unique_id']; ?>"><img src="img/view.png"  align="middle"width="100px" height="30px" title="View"/></a></td>
				</tr>
				<?php
				}
				?>
			...
			<table  align="center" style= "width:400px">
				<tr>
					<td><a href="p_display_appointment.php?page=<?php echo $prepage; ?>" class="btn btn-rounded btn-default">Prepage</a></td>
					<td><a href="p_display_appointment.php?page=<?php echo $nextpage; ?>" class="btn btn-rounded btn-default">Nextpage</a></td>
					<td><a href="p_display_appointment.php?page=<?php echo $maxpage; ?>" class="btn btn-rounded btn-default">Maxpage</a></td>
				</tr>
			</table>
