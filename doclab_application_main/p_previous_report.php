...
<?php
$noofrecords=10;
$select="select * from  tbl_laboratory_report c1 , tbl_appointment c2 where c1.lab_id='$_GET[lab_id]' and c2.pat_id='$_SESSION[pat_id]' and c1.appointment_id=c2.appointment_id  group by c2.appo_unique_id";
...
<div class="panel panel-default">
		...
		<form  method="post" class="form-horizontal">
			  ...
			  {
				window.location.href="p_previous_report.php?lab_id="+l;
			  }
			  </script>
			 <div class="form-group has-success">
				  ...
				  <option>---------------Select Laboratory Name---------------</option>
                    <?php
					$select="select * from tbl_laboratory_report c1, tbl_laboratory c2 where c1.lab_id=c2.lab_id group by c1.lab_id ";
					$query=mysql_query($select);
		 ...
		 <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
				...
				<!-- SELECT -->
				<?php
				$select="select * from  tbl_laboratory_report c1 , tbl_appointment c2 where c1.lab_id='$_GET[lab_id]' and c2.pat_id='$_SESSION[pat_id]' and c1.appointment_id=c2.appointment_id  group by c2.appo_unique_id".$limit;
				$query=mysql_query($select);
				while($row=mysql_fetch_array($query))
				{
				?>
				...
				?></td>
						...
						<td style="width:20px;"><a href="p_previous_report_details.php?appo_unique_id=<?php echo $row['appo_unique_id']; ?>"><img src="img/detail1.jpg"  align="middle"width="100px" height="30px" title="View"/></a></td>
				</tr>
				<?php
				}
				?>
			...
			<table  align="center" style= "width:400px">
				<tr>
					<td><a href="p_previous_report.php?page=<?php echo $prepage; ?>" class="btn btn-rounded btn-default">Prepage</a></td>
					<td><a href="p_previous_report.php?page=<?php echo $nextpage; ?>" class="btn btn-rounded btn-default">Nextpage</a></td>
					<td><a href="p_previous_report.php?page=<?php echo $maxpage; ?>" class="btn btn-rounded btn-default">Maxpage</a></td>
				</tr>
			</table>
