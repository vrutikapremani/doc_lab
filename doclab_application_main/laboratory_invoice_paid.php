...
<div class="container-padding">
  ...
  <div class="invoice row">
    ...
    <div class="logo">
      ...
      <?php echo strtoupper($row['lab_city']); ?>-<?php echo ucfirst($row['lab_pincode']); ?>,<?php echo $row['lab_state']; ?>.<br>
...
<input type='hidden' name='return'  value='http://localhost/doc_lab/pl_success_payment.php'>
<table align="right">
