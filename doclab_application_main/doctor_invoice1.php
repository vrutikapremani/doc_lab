...
<?php
$noofrecords=10;
$select="select * from  tbl_doctor_invoice c1 , tbl_symptom c2 where c1.sym_id=c2.sym_id and c1.unique_id='$_GET[unique_id]' and d_invoice_status=1";
...
<div class="panel panel-default">
		...
		<?php
		$s="select * from  tbl_doctor_invoice c1 , tbl_symptom c2 where c1.sym_id=c2.sym_id and c1.unique_id='$_GET[unique_id]' and d_invoice_status=1";
				$q=mysql_query($s);
		 ...
		 <div class="panel-body table-responsive">
            ...
            <table id="example0" class="table display">
				...
				$select_search="select * from tbl_doctor_invoice c1 , tbl_symptom c2 where c1.sym_id=c2.sym_id and d_invoice_status=1 and c2.sym_name like '%$search%'";
				$query=mysql_query($select_search);
				}
				else
				{
				$select="select * from  tbl_doctor_invoice c1 , tbl_symptom c2 where c1.sym_id=c2.sym_id and c1.unique_id='$_GET[unique_id]' and d_invoice_status=1".$limit;
				$query=mysql_query($select);
				}
			    ...
			    <tr>
						...
						<td style="width:20px;"><a href="doctor_invoice_paid.php?d_invoice_id=<?php echo $row['d_invoice_id']; ?>"><img src="img/view.png"  align="middle"width="100px" height="30px" title="View"/></a></td>
				</tr>
				<?php
				}
				?>
			...
			<table  align="center" style= "width:400px">
				<tr>
					<td><a href="doctor_invoice1.php?page=<?php echo $prepage; ?>" class="btn btn-rounded btn-default">Prepage</a></td>
					<td><a href="doctor_invoice1.php?page=<?php echo $nextpage; ?>" class="btn btn-rounded btn-default">Nextpage</a></td>
					<td><a href="doctor_invoice1.php?page=<?php echo $maxpage; ?>" class="btn btn-rounded btn-default">Maxpage</a></td>
				</tr>
			</table>
