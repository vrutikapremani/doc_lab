  ...
  <body>
    ...
    <div class="login-form">
      ...
      <div class="footer-links row">
        <div class="col-xs-6"><a href="login_patient.php"><i class="fa fa-sign-in"></i> Login</a></div>
        <div class="col-xs-6 text-right"><a href="add_patient.php"><i class="fa fa-external-link"></i> Register Now</a></div>
      </div>
    </div>
